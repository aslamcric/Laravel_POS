                ...
                <div class="login-content">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="login-userset">
                            ...
                            <div class="my-4 d-flex justify-content-center align-items-center copyright-text">
                                <p>Copyright © <span id="current-year"></span> DevAslam. All rights reserved</p>
                            </div>
                        </div>
                    </form>
    ...
    <div class="customizer-links" id="setdata">
        <ul class="sticky-sidebar">
            <li class="sidebar-icons">
                <a href="https://dreamspos.dreamstechnologies.com/html/template/signin.html#" class="navigation-add"
                    data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Theme">
