        ...
        $(function() {
            ...
            $('.btn_process').on('click', function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        console.log(error);@extends('layout.erp.app')
            ...
            $('.btn_process').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        // Open a new window for order confirmation
                        let orderWindow = window.open('', '_blank', 'width=800,height=600');

                        // Add order details to the new window
                        orderWindow.document.write('<html><head><title>Order Invoice</title></head><body>');
                        orderWindow.document.write('<h1>Order Details</h1>');
                        orderWindow.document.write('<p><strong>Customer ID:</strong> ' + customer_id + '</p>');
                        orderWindow.document.write('<p><strong>Order Total:</strong> ' + order_total + '</p>');
                        orderWindow.document.write('<p><strong>Paid Amount:</strong> ' + paid_amount + '</p>');
                        orderWindow.document.write('<p><strong>Discount:</strong> ' + discount + '</p>');
                        orderWindow.document.write('<p><strong>VAT:</strong> ' + vat + '</p>');

                        // Generate the products list
                        orderWindow.document.write('<h3>Products:</h3>');
                        orderWindow.document.write('<ul>');
                        products.forEach(product => {
                            orderWindow.document.write('<li>' + product.name + ' - ' + product.qty + ' x $' + product.price + ' = $' + product.subtotal + '</li>');
                        });
                        orderWindow.document.write('</ul>');

                        // Add print button
                        orderWindow.document.write('<button onclick="window.print()">Print</button>');
                        orderWindow.document.write('</body></html>');

                        // Close the window after loading content
