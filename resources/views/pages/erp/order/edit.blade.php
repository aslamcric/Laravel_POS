...
<div class="row mb-3">
	...
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="order_date" value="{{$order->order_date}}" id="order_date" placeholder="Order Date">
	</div>
</div>
<div class="row mb-3">
	<label for="delivery_date" class="col-sm-2 col-form-label">Delivery Date</label>
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="delivery_date" value="{{$order->delivery_date}}" id="delivery_date" placeholder="Delivery Date">
	</div>
</div>
<div class="row mb-3">
